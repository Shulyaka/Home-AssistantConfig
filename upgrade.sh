...
pip3 install --upgrade --upgrade-strategy=eager -c /srv/homeassistant/lib/python3.12/site-packages/homeassistant/package_constraints.txt music_assistant zlib_ng isal $@
